...
{
    //Information Person's inherentinate Manager class
    public class Person : Manager
    {
        private string name, emailAddress, password;


        public static string PATH = "Person.txt"; //path to saving data
        ...
        public void Display()
        {
            Console.WriteLine("{0,-20}|{1,-20}|{2,-20}|{3,-20}", name, emailAddress, password,
                Roles); //display information's object
        }
        ...
        public override string ToString()
        {
            return Roles + "#" + name + "#" + emailAddress + "#" +
                   password; //return the string, the information has splice "#"
        }
    }
}