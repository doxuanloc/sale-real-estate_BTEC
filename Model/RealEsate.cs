...
namespace Project1.Model
{
    ...
    public class RealEsate
    {
        ...
        public static string PATH = "RealEsate.txt"; //The file to saving data
        ...
        public void Input() //Enter information
        {
        ...
        public void Display()
        {
            Console.WriteLine("{0,-30}|{1,-30}|{2,-30}|{3,-30}|{4,-30}", name, price, houseOwnershipCertificate,
                amountBedroomAndBathRoom, description); ////display information's object
        }
        ...
        public override string ToString()
        {
            return id + "#" + name + "#" + price + "#" + categoryId + "#" + houseOwnershipCertificate + "#" +
                   ...
                   "#" + description; //return the string, the information has splice "#"
        }
    }
}